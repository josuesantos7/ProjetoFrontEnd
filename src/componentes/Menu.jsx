    ...
    return (
        <div className="menu">
            ...
            <div className="menu-opcoes">
                <Link className="hiperlink" to="/dashboard">
                ...
                <Link className="hiperlink" to="/login">
                    <div className="menu-itens">
                ...
                <Link className="hiperlink" to="/cadastrar">
                    <div className="menu-itens">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-pin-map-fill" viewBox="0 0 16 16">
